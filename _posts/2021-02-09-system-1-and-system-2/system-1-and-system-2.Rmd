...
description: |
  Introducing the two main characters of the story
author:
  - name: Amit Gandhi
    url: {}
date: 02-09-2021
...
![](https://www.amacad.org/sites/default/files/academy/images/publications/bulletin/winter2012/bulletinWinter2012_Mind_Fig1.jpg)
...
![Interpretation of Stroop Task](strooptaskmeaning.png)
...
between saying "blue" when looking at <font color = "blue"> red </font>. Also, there
is conflict between saying "red" when looking at a <font color = "red"> blue </font>. The
...
```{r}
vembedr::embed_youtube("vJG698U2Mvo")
```
...
psychology: the Walter Mischel cookie/marshmallow experiment

```{r}
vembedr::embed_youtube("BLtQaRrDsC4")
```
